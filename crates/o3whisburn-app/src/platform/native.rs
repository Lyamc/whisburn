use o3whisburn_core::{load_settings, save_settings, Settings};
...
pub fn settings_hint() -> &'static str {
    "Saved to the o3whisburn config directory (settings.toml). Server reads these on startup unless CLI flags override."
}