...
use o3whisburn_audio::{encode_result_with_options, AudioExportFormat, OpusBitrate};
use o3whisburn_core::{LanguageCode, OutputFormat, SpeechTask, TaskOptions, O3WhisburnError};
use o3whisburn_engine::model::registry::{self, ModelTier};
...
pub struct ServerConfigResponse {
    ...
    pub preload_models: o3whisburn_core::PreloadModels,
...
pub async fn transcode_stream(
    ...
    if !o3whisburn_audio::ffmpeg_available() {
        return Err(ApiError::from(O3WhisburnError::UnsupportedCapability {
...
impl From<O3WhisburnError> for ApiError {
    fn from(value: O3WhisburnError) -> Self {
        let status = match &value {
            O3WhisburnError::InvalidRequest(_) => StatusCode::BAD_REQUEST,
            O3WhisburnError::UnsupportedCapability { .. } => StatusCode::NOT_IMPLEMENTED,
