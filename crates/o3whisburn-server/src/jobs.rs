...
use o3whisburn_core::{SpeechTask, O3WhisburnError, TaskOptions, TranscriptResult, TranscriptSegment};
use o3whisburn_models::diarize::assign_alternating_speakers;
            ...
            |waveform| {
                let part = manager
                    ...
                    .map_err(|e| {
                        ...
                        O3WhisburnError::Inference(e.to_string())
                    })?;
