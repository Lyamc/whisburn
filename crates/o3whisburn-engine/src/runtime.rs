...
use o3whisburn_core::{
    SpeechTask, TaskOptions, TranscriptResult, TranscriptSegment, O3WhisburnError, O3WhisburnResult,
};
...
impl InferenceRuntime {
    ...
    pub fn warm_model(&self, model_name: &str) -> O3WhisburnResult<()> {
        {
    ...
    fn transcribe_with<B: Backend>(
        ...
        .map_err(|e| O3WhisburnError::Inference(e.to_string()))?;
    ...
    fn transcribe_orchestrated(
        ...
        let device = match &self.backend {
            ...
            BackendRuntime::NdArray { .. } => {
                return Err(O3WhisburnError::Inference(
